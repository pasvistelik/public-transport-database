            ...
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                ...
                for (i = 0, n = positions.length, currentItem = positions[0]; i < n; currentItem = positions[++i]) {
                  request += request_begin + " (" + currentItem.positionId + ", " + (currentItem.previousPositionId == null ? "\"null\"" : currentItem.previousPositionId) + ", " + (currentItem.nextPositionId == null ? "\"null\"" : currentItem.nextPositionId) + ", " + currentItem.lat + ", " + currentItem.lng + ", " + (currentItem.vehicleId == null ? "\"null\"" : currentItem.vehicleId) + ", " + "\"" + currentItem.dateDDMMYY + "\", " + currentItem.dayOfWeek + ", " + currentItem.timeSeconds + ", " + (currentItem.routeId == null ? "\"null\"" : "(SELECT route_id FROM routes WHERE tmp_route_hashcode='" + currentItem.routeId + "' LIMIT 1)") + ", " + (currentItem.wayId == null ? "\"null\"" : currentItem.wayId) + ", " + (currentItem.tripId == null ? "\"null\"" : currentItem.tripId) + ");\n";
                }
