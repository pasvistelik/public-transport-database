    ...
    return _regenerator2.default.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _connection = _mysql2.default.createConnection(connConfig);
  ...
  (0, _createClass3.default)(TransportDatabase, null, [{
        ...
        return _regenerator2.default.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return executeQuery("SELECT MAX(position_id) FROM gps_positions_archive AS solution");
              ...
              case 2:
                ...
                return _context3.abrupt("return", results[0].solution);
    ...
    value: function () {
      var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(positions) {
        var request, i, n, currentItem, results;
        return _regenerator2.default.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                request = "INSERT INTO gps_positions_archive(position_id, previous_position_id, next_position_id, lat, lng, vehicle_id, date, day_of_week, time_seconds, route_id, way_id, trip_id) VALUES";


                for (i = 0, n = positions.length, currentItem = positions[0]; i < n; currentItem = positions[++i]) {
                  request += " (" + currentItem.positionId + ", " + currentItem.previousPositionId + ", " + currentItem.nextPositionId + ", " + currentItem.lat + ", " + currentItem.lng + ", " + (currentItem.vehicleId == null ? null : currentItem.vehicleId) + ", " + "\"" + currentItem.dateDDMMYY + "\", " + currentItem.dayOfWeek + ", " + currentItem.timeSeconds + ", " + (currentItem.routeId == null ? null : currentItem.routeId) + ", " + (currentItem.wayId == null ? null : currentItem.wayId) + ", " + (currentItem.tripId == null ? null : currentItem.tripId) + ", " + "),";
                }
